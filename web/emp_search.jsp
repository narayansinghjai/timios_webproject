...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/blur1.jpg');">
    <div id="pageintro" class="hoc clear">
      ...
      <article>
		...
		<form action="hr_emp_search">
     
    <p>Choose The Type  </p>
      <select name="profileselect" style="color: black">
          <option style="color: black">EMPLOYEE ID</option>
          <option style="color: black">NAME</option>
          <option style="color: black">PHONE NUMBER</option>
      </select>
    <br>
    <p>Enter Here  </p>
