...
<table id="customers">
  <tr>
    ...
    <th><center>HRA</center></th>
    <th><center>CONVEY ALLOWANCE</center></th>
    <th><center>MEDICAL ALLOWANCE</center></th>
    <th><center>CCA</center></th>
    <th><center>SPECIAL ALLOWANCE</center></th>
...
<td><a href="salary_accept?value=<%out.println(list2.get(0));%>">accept</a>
  </tr>
  <%}%>
