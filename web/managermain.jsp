...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/blur1.jpg');">
    <div id="pageintro" class="hoc clear">
      ...
      <article>
       ...
       <div class="dropdown">
  <li><a class="btn inverse" href="manager_employee" >EMPLOYEE DETAILS</a></li>
  <div class="dropdown-content">
    <a href="manager_employee">MY TEAM</a>
    <a href="managerdept.jsp">Search by department</a>
            ...
            <li><a class="btn inverse" href="manager_emp.jsp" target="_self">SALARY</a></li>
</ul>
        </footer>
      </article>
